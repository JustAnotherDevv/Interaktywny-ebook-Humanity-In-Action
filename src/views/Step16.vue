<template>
    <Step hide-skip-button class="text-white font-liber">
        <div>
            ...
            <div
                class="flex flex-col items-center justify-center text-center bg-no-repeat bg-contain p-6 md:p-10 mt-20 bg-center md:bg-[url(assets/16/frame.svg)] border border-white rounded-2xl md:border-none"
            >
                <img
                    src="/assets/16/jakie-masz-przemyslenia.svg"
                    alt=""
                    width="466"
                    height="135"
                />
                <div class="max-w-md">
                    ...
                    <p>
                        ...
                        Natomiast język prawniczy i trudne terminy mogą Ci się
                        przydać w przyszłości. W razie wątpliwości zawsze możesz
                        skorzystać ze Słowniczka.
                    </p>
                </div>
            </div>
        </div>
