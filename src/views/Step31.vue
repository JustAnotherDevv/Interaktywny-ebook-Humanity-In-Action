    ...
    <Step hide-skip-button>
        <div class="space-y-8">
            ...
            <p class="max-w-2xl md:text-center">
                Mowa nienawiści wbrew pozorom nie jest „wynalazkiem” naszych
                czasów. W historii ludzkości była niestety wielokrotnie używana.
                Zazwyczaj po to, by ułatwić grupie dominującej skuteczne
            ...
            <p class="font-amatic text-3xl max-w-2xl md:text-center">
                ...
                w. i Polska jest krajem na ogół przestrzegającym praw
