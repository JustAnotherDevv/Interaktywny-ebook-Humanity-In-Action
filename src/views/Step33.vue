<template>
    <Step hide-skip-button>
        <img
            src="/assets/33/do-refleksji.svg"
            alt=""
            width="339"
            height="98"
            class="mb-10"
        />
        <div class="bg-black text-white p-6 md:px-20 text-xl mb-10 text-center">
            A jak się ma ta pozornie odległa historia do czasów współczesnych?
        </div>
